...
# Функция для отображения надписи WingsNodeTeam
display_logo() {
    echo -e "\e[1;34m" # Устанавливаем синий цвет текста
    echo "======================================"
    echo "            WingsNodeTeam             "
    echo "======================================"
    echo -e "\e[0m" # Сбрасываем цвет текста
}
...
case $choice in
    1)
        ...
        echo -e "${PURPLE}-----------------------------------------------------------------------${NC}"
        echo -e "${GREEN}WingsNodeTeam — весь мир Web3 в одном месте!${NC}"
        echo -e "${CYAN}Наш Telegram https://t.me/WingsNodeTeam${NC}"
        sleep 2
